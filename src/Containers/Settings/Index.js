      ...
      >
        ...
        >
          <View style={[Layout.row, Layout.alignItemsCenter]}>
            <Button
              title={"Device password settings"}
              clickCallback={devicePasswordCallback}
          ...
          <View style={[Layout.row, Layout.alignItemsCenter]}>
            <Button
              title={"Device wifi settings"}
              clickCallback={deviceWifiCallback}
              color={Colors.secondaryGreen}
              style={Layout.fill}
            />
          </View>
          ...
          <View style={[Layout.row, Layout.alignItemsCenter]}>
            <Button
              ...
              clickCallback={deleteAccountCallback}
              color={Colors.red}
              style={Layout.fill}
            />
          </View>
