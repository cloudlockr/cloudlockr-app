...
const UploadDownloadProgressContainer = () => {
    ...
    const fileType = transferInfo.fileMetadata !== undefined ? transferInfo.fileMetadata.type : undefined;
    ...
    useFocusEffect(
        React.useCallback(() => {
            ...
            if (isDownloading) {
                ...
                UploadService(dispatch, fileUri, fileName, fileType, userToken, userEmail);
            }
