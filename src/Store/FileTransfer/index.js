...
export default buildSlice('fileTransfer', [SetDetails, SetUploadDownloadProgress, ResetUploadDownloadProgress, AddEncryptionComponent, RemoveEncryptionComponent], {
  details : initialState.fileTransfer.details,
  progress: initialState.fileTransfer.progress,
  encryptionComponents: {},
}).reducer

export { SetUploadDownloadProgress, ResetUploadDownloadProgress, AddEncryptionComponent, RemoveEncryptionComponent };
